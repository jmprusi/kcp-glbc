...
import (
	...
	scopedclientset "github.com/kuadrant/kcp-glbc/pkg/client/kuadrant/clientset/versioned"
		kuadrantinformers "github.com/kuadrant/kcp-glbc/pkg/client/kuadrant/informers/externalversions/kuadrant"
...
type SharedInformerFactory interface {
	...
	Kuadrant() kuadrantinformers.ClusterInterface
}


func (f *sharedInformerFactory) Kuadrant() kuadrantinformers.ClusterInterface {
  return kuadrantinformers.New(f, f.tweakListOptions)
}
...
type SharedScopedInformerFactory interface {
	...
	Kuadrant() kuadrantinformers.Interface
}



func (f *sharedScopedInformerFactory) Kuadrant() kuadrantinformers.Interface {
  return kuadrantinformers.NewScoped(f, f.namespace, f.tweakListOptions)
}
